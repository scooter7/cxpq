...
def personality_quiz():
    ...
    if "randomized_traits" not in st.session_state:
        st.session_state.randomized_traits = random.sample(traits, len(traits))

    selected_traits_q1 = []
    for trait in st.session_state.randomized_traits:
    ...
    if len(selected_traits_q1) == 3:
        ...
        selected_single_trait_q2 = st.radio("", selected_traits_q1, key="radio_q2",
                                           index=selected_traits_q1.index(st.session_state.get("selected_single_trait_q2")))
        st.session_state.selected_single_trait_q2 = selected_single_trait_q2

        st.write("---")

        if st.session_state.selected_single_trait_q2:
            ...
            if len(least_represented_traits_q3) == 3:
                ...
                if len(selected_traits_q4) == 3:
                    ...
                    selected_single_trait_q5 = st.radio("", selected_traits_q4, key="radio_q5",
                                                       index=selected_traits_q4.index(st.session_state.get("selected_single_trait_q5")))
                    st.session_state.selected_single_trait_q5 = selected_single_trait_q5

                    st.write("---")

                    if st.session_state.selected_single_trait_q5:
