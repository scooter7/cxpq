...
def personality_quiz():
    ...
    random_traits_q1 = random.sample(traits, len(traits))

    selected_traits_q1 = []
    for trait in random_traits_q1:
    ...
    if len(selected_traits_q1) == 3:
        ...
        random_selected_single_trait_q2 = random.choice(selected_traits_q1)
        
        selected_single_trait_q2 = st.radio("", selected_traits_q1, index=random_traits_q1.index(random_selected_single_trait_q2), key="radio_q2")
        ...
        random_remaining_traits_q3 = random.sample(remaining_traits_q3, len(remaining_traits_q3))

        least_represented_traits_q3 = []
        for trait in random_remaining_traits_q3:
        ...
        if len(least_represented_traits_q3) == 3:
            ...
            random_traits_q4 = random.sample(traits_q4, len(traits_q4))

            selected_traits_q4 = []
            for trait in random_traits_q4:
            ...
            if len(selected_traits_q4) == 3:
                ...
                random_selected_single_trait_q5 = random.choice(selected_traits_q4)
                
                selected_single_trait_q5 = st.radio("", selected_traits_q4, index=random_traits_q4.index(random_selected_single_trait_q5), key="radio_q5")

                st.write("---")

                remaining_traits_q6 = [trait for trait in traits_q4 if trait not in selected_traits_q4]
                
                random_remaining_traits_q6 = random.sample(remaining_traits_q6, len(remaining_traits_q6))
                ...
                for trait in random_remaining_traits_q6:
                ...
                if len(least_represented_traits_q6) == 3:
                    ...
                    for i, file in enumerate(random_image_files_q7):
                    ...
                    if len(selected_images_q7) == 3:
                        ...
                        random_selected_image_q8 = random.choice(selected_images_q7)
                        ...
                        if selected_image_q8:
                            ...
                            random_remaining_images_q9 = random.sample(remaining_images_q9, len(remaining_images_q9))

                            least_represented_images_q9 = []

                            for i, file in enumerate(random_remaining_images_q9):
                                image_url = f"https://raw.githubusercontent.com/scooter7/cxpq/main/{file}"
                                response = requests.get(image_url)
                                image = Image.open(BytesIO(response.content))
                            ...
                            if len(least_represented_images_q9) == 3:
                                ...
                                selected_modes_q10 = []
                                for mode in random_modes_of_connection:
