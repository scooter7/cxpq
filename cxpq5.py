...
def personality_quiz():
    ...
    selected_traits_q1 = st.multiselect("Q1. Here is a list of 9 traits that could make up your personality. Please select exactly 3 traits that best represent who you are.", traits, key="q1")
    ...
    if len(selected_traits_q1) == 3:
        selected_single_trait_q2 = st.radio("Q2. Of the 3 traits you selected, which single trait is most like you?", selected_traits_q1, key="q2")

        st.write("---")

        remaining_traits_q3 = [trait for trait in traits if trait not in selected_traits_q1]

        least_represented_traits_q3 = st.multiselect("Q3. Now think about this list and select the 3 traits that least represent who you are.", remaining_traits_q3, key="q3")
        ...
        if len(least_represented_traits_q3) == 3:
            ...
            selected_traits_q4 = st.multiselect("Q4. Here is a new list of 9 traits that could make up your personality. Please select exactly 3 traits that best represent who you are.", traits_q4, key="q4")
            ...
            if len(selected_traits_q4) == 3:
                selected_single_trait_q5 = st.radio("Q5. Of the 3 traits you selected, which single trait is most like you?", selected_traits_q4, key="q5")

                st.write("---")

                remaining_traits_q6 = [trait for trait in traits_q4 if trait not in selected_traits_q4]

                least_represented_traits_q6 = st.multiselect("Q6. Now think about this list and select the 3 traits that least represent who you are.", remaining_traits_q6, key="q6")
                    ...
                    if len(selected_images_q7) == 3:
                        ...
                        if selected_image_q8:
                            ...
                            if len(least_represented_images_q9) == 3:
                                ...
                                selected_modes_q10 = st.multiselect("Q10. Below are 9 things called 'Modes of Connection.' They describe how a person can make an impression, grow friendships, and inspire others. Which two 'Modes of Connection' sound most like what you would use to make an impression, grow friendships, and inspire others?", modes_of_connection, key="q10")
