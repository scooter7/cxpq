                ...
                def personality_quiz():
                    ...
                    def run_quiz():
                        for answer in selected_traits_q1:
                            ...
                            score_counter[
                                trait_score_map[selected_single_trait_q2]
                            ] += 1
                            for answer in least_represented_traits_q3:
                                ...
                                for answer in selected_traits_q4:
                                    score_counter[trait_score_map[answer]] += 1
                                    score_counter[
                                        trait_score_map[selected_single_trait_q5]
                                    ] += 1
                                    for answer in least_represented_traits_q6:
                                        ...
                                        for image in selected_images_q7:
                                            ...
                                            score_counter[
                                                image_score_map[selected_image_q8]
                                            ] += 1
                                            for image in least_represented_images_q9:
                                                score_counter[
                                                    image_score_map[image]
                                                ] -= 1
                                                for mode in selected_modes_q10:
                                                    score_counter[
                                                        trait_score_map[mode]
                                                    ] += 1
                                                    sorted_scores = sorted(
                                                        score_counter.items(),
                                                        key=lambda item: (
                                                            -item[1],
                                                            color_priority.index(
                                                                item[0]
                                                            ),
                                                        ),
                                                    )
                                                    ...
                                                    def get_persona_name(
                                                        ...
                                                        st.write(
                                                            "Q1. Here is a list of 9 traits that could make up your personality. Please select exactly 3 traits that best represent who you are."
                                                        )
                                                        selected_traits_q1 = [
                                                            trait
                                                            for trait in traits
                                                            if st.checkbox(
                                                                trait,
                                                                key=f"checkbox_q1_{trait}",
                                                            )
                                                        ]
                                                        if len(selected_traits_q1) != 3:
                                                            st.warning(
                                                                "Please select exactly 3 traits."
                                                            )
                                                            st.write("---")

                                                            if (
                                                                len(selected_traits_q1)
                                                                == 3
                                                            ):
                                                                st.write(
                                                                ...
                                                                if (
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        st.write(
                                                                            "Q4. Here is a new list of 9 traits that could make up your personality. Please select exactly 3 traits that best represent who you are."
                                                                        )
                                                                        traits_q4 = [
                                                                            "Influential",
                                                                            "Adventurous",
                                                                            ...
                                                                            if (
                                                                                ...
                                                                                if (
                                                                                    ...
                                                                                    if (
                                                                                        ...
                                                                                        st.write(
                                                                                            "Q7. On this page there are 9 groups of icons meant to represent personalities. Please take a moment to view all the groups. Then select the 3 that best represent who you are."
                                                                                        )
                                                                                        image_files_q7 = [
                                                                                            "OrangeSet.jpg",
                                                                                            "BrownSet.jpg",
                                                                                                    ...
                                                                                                    if selected:
                                                                                                        ...
                                                                                                        if (
                                                                                                            ...
                                                                                                            if (
                                                                                                                ...
                                                                                                                st.write(
                                                                                                                    "Q8. Of the 3 you selected, which group of icons is most like you?"
                                                                                                                )
                                                                                                                    ...
                                                                                                                    if selected:
                                                                                                                        if selected_image_q8:
                                                                                                                            ...
                                                                                                                            if selected_image_q8:
                                                                                                                                ...
                                                                                                                                if selected_image_q8:
                                                                                                                                    st.write(
                                                                                                                                        "Q9. Now think about these icon groups remaining and select the 3 that least represent who you are."
                                                                                                                                    )
                                                                                                                                    remaining_images_q9 = [
                                                                                                                                        file
                                                                                                                                        for file in image_files_q7
                                                                                                                                        if file
                                                                                                                                        not in selected_images_q7
                                                                                                                                    ]
                                                                                                                                    random.seed(
                                                                                                                                        st.session_state.get(
                                                                                                                                            "random_seed",
                                                                                                                                    ...
                                                                                                                                    for (
                                                                                                                                        ...
                                                                                                                                        if selected:
                                                                                                                                            least_represented_images_q9.append(
                                                                                                                                                file
                                                                                                                                            )
                                                                                                                                            cols_q9[
                                                                                                                                                i
                                                                                                                                            ...
                                                                                                                                            if (
                                                                                                                                                ...
                                                                                                                                                if (
                                                                                                                                                    ...
                                                                                                                                                    st.write(
                                                                                                                                                        "Q10. Below are 9 things called 'Modes of Connection.' They describe how a person can make an impression, grow friendships, and inspire others. Which two 'Modes of Connection' sound most like what you would use to make an impression, grow friendships, and inspire others?"
                                                                                                                                                    )
                                                                                                                                                    modes_of_connection = [
                                                                                                                                                        "Achieve With Me",
                                                                                                                                                        "Explore With Me",
                                                                                                                                                    ...
                                                                                                                                                    if (
                                                                                                                                                        ...
                                                                                                                                                        if st.button(
                                                                                                                                                            ...
                                                                                                                                                            if (
                                                                                                                                                                ...
                                                                                                                                                                st.warning(
                                                                                                                                                                    "Please provide an ID before submitting."
                                                                                                                                                                )
                                                                                                                                                            else:
                                                                                                                                                                (
                                                                                                                                                                    top_two_colors,
                                                                                                                                                                ...
                                                                                                                                                                st.write(
                                                                                                                                                                    "Your top two colors are: ",
                                                                                                                                                                    ", ".join(
                                                                                                                                                                        top_two_colors
                                                                                                                                                                    ),
                                                                                                                                                                )
                                                                                                                                                                st.write(
                                                                                                                                                                    "Your persona name is: ",
                                                                                                                                                                    persona_name,
                                                                                                                                                                )
                                                                                                                                                                st.write(
                                                                                                                                                                    "Total Scores for Each Color:"
                                                                                                                                                                )
                                                                                                                                                                for color in color_priority:
                                                                                                                                                                    st.write(
                                                                                                                                                                        f"{color}: {score_counter[color]}"
                                                                                                                                                                    )
                                                                                                                                                                    ...
                                                                                                                                                                    if (
                                                                                                                                                                        ...
                                                                                                                                                                        if (
                                                                                                                                                                            ...
                                                                                                                                                                            st.session_state.random_seed = random.randint(
                                                                                                                                                                                0,
                                                                                                                                                                                1000000,
                                                                                                                                                                            )
