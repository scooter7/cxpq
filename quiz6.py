...
def personality_quiz():
    ...
    if len(selected_traits_q1) == 3:
        ...
        if selected_single_trait_q2:
            st.write("You selected:", selected_single_trait_q2)
        ...
        if len(least_represented_traits_q3) == 3:
            ...
            if len(selected_traits_q4) == 3:
                ...
                selected_single_trait_q5 = st.radio("", selected_traits_q4, key="radio_q5", index=None)
                if selected_single_trait_q5:
                    st.write("You selected:", selected_single_trait_q5)
                            ...
                            if len(least_represented_images_q9) == 3:
                                ...
                                if st.button("Submit"):
                                    if len(selected_traits_q1) != 3:
                                        ...
                                        st.write("Score Counter: ", score_counter)
                                        st.write("---")
                                        st.write("Thank you for completing the CollegeXpress Personality Survey!")

    if 'random_seed' not in st.session_state:
        st.session_state.random_seed = random.randint(0, 100000)
