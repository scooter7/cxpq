...
def personality_quiz():
    ...
    if len(selected_traits_q1) == 3:
        ...
        elected_single_trait_q2 = st.radio("Q2. Of the 3 traits you selected, which single trait is most like you?", options=[""] + selected_traits_q1, index=None, key="radio_q2")
