                    ...
                    if len(selected_images_q7) == 3:
                        ...
                        if selected_image_q8:
                            ...
                            if len(least_represented_images_q9) == 3:
                                ...
                                st.write("---")
                                st.write("Before you submit, please fill in the following mandatory fields:")

                                full_name = st.text_input("Full Name")
                                email_address = st.text_input("Email Address")
                                affiliation_options = ["Admitted Student", "Current Student", "Faculty/Staff", "Alum"]
